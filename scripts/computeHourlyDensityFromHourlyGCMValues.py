...
#                                                                              #
#    From GCM hourly values of T, PS and Q, compute vertical profiles of RHO   #
#    in each GCM grid cell.                                                    #
#                                                                              #
################################################################################
...
if __name__ == "__main__":
	...
	outputfile = "RHO_1hr_CESM111-SPCAM20_"+experiment+"_r1i1p1_"+datetime1+'-'+\
		datetime2+".nc"
	...
	rho_dims = fh_source.variables[temp_id].dimensions
	rho_shape = fh_source.variables[temp_id].shape
	...
	rootgrp.description = "Hourly RHO values from CESM111-SPCAM20 in the "+experiment+" scenario"
	...
	rho = rootgrp.createVariable(rho_id,"f4",rho_dims)
	...
	temp_values = np.zeros((n,rho_shape[1],nlat/3,rho_shape[3]))
	spechum_values = np.zeros((n,rho_shape[1],nlat/3,rho_shape[3]))
	pressurf_values = np.zeros((n,nlat/3,rho_shape[3]))
	...
	for i in range(n):
		...
		spechum_values[i] = fh.variables[spechum_id][:,:,lat_slice,:]
