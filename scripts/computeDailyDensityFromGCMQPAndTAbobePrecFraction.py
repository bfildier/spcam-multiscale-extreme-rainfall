...
#                                                                              #
#    From GCM daily (ie. mesoscale) values of PS and Q and convective-scale    #
#    values of T (CRM-T-IXX), compute daily vertical profiles of RHO in each   #
#    GCM grid cell (name it RHO_CRM_T_IXX).                                    #
#    If the fraction entered if a negative integer, use the mesoscale variable #
#    T and compute the daily GCM-scale variable RHO.                           #
#                                                                              #
################################################################################
...
if __name__ == "__main__":
	...
	outputfile = "%s_day_CESM111-SPCAM20_%s_r1i1p1_%s-%s.nc"%\
		(rho_id.replace('_','-'),experiment,datetime1,datetime2)
	...
	rho_dims = fh_source.variables[ref_id].dimensions
	...
	spechum_values = getVar(spechum_id,inputdir_processed_day,dates=(datetime1,datetime2))
