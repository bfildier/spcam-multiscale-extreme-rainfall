...
#                                                                            #
#    From (daily) mesoscale values of RHO_MESO (itself computed from meso-   #
#    scale T, Q and p) and convective-scale values CRM_W_IXX, compute the    #
#    mean pressure velocity outside the convective-scale events.             #
#    Call it OMEGA_CRM_W_IXX.                                                #
#                                                                            #
##############################################################################
...
if __name__ == "__main__":
	...
	if fraction < 0:
		...
		indvarid = "O%d"%fraction
		w_id = 'CRM_W_%s'%indvarid
		omega_id = "OMEGA_CRM_W_%s"%indvarid
